...
public class ExtentManager {
    public static final String reportFileName =
            "E2E_API_ExecutionReport" + "_" + new SimpleDateFormat("dd-MM-yyyy hh-mm-ss-ms").format(new Date())
                    + ".html";
    ...
    public static ExtentReports createInstance() {
        ...
        htmlReporter.config().setDocumentTitle("E2E API Report");
        htmlReporter.config().setEncoding("utf-8");
        htmlReporter.config()
                .setReportName("E2E API Execution Report on " + Constants.ENVIRONMENT_NAME + " Environment");
